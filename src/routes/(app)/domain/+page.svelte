    ...
    <div class="flex items-center gap-2 max-md:flex-wrap max-md:justify-center">
      ...
      <SortBy 
        ...
        columns={[
          ...
          { value: 'name', label: 'Domain Name', type: 'text' },
          { value: 'paymentStatus', label: 'Payment Status', type: 'text' },
          { value: 'statusMessage', label: 'Status Message', type: 'text' }
        ]}
      />
            ...
            <tr class="transition-all duration-500 hover:bg-gray-50">
              ...
              <td class="py-3.5 px-4">
                <div class="flex font-poppins">
                  ...
                  <a href="/domain/update/{row.id}" class="mr-2" aria-label="Update">
                    <svg
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
                ...
                >
                  ...
                  ></path>
                    ...
                    <a href={`/domain/view/${row.id}`} class="mr-2" title="View Domain" aria-label="View Domain">
                      <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
