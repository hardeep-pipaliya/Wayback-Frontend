  ...
  <div class="max-w-5xl mx-auto mt-4">
    ...
    {:else if currentStep === 3}
      ...
      <div class="rounded-2xl border border-gray-200">
        <div
          class="px-4 py-3 border-b border-gray-200 bg-gray-50 rounded-t-2xl"
        >
        ...
        <div class="flex-1 flex flex-col gap-4">
          ...
          <div class="p-4 rounded-lg shadow w-full">
            <div class="flex gap-8 mt-4">
              <!-- Total Articles -->
              <div
                class="flex items-center justify-between px-4 w-full md:w-1/3"
              >
              ...
              >
                <div class="flex flex-col">
                  ...
                  <span id="total-size" class="text-2xl font-bold"
                    >45.37 KB</span
                  >
                </div>
                <svg
          ...
          <div class="bg-white p-4 border-gray-200 rounded-lg shadow w-full">
            ...
            <div class="flex justify-between text-sm text-gray-600 mt-2">
              <p>
                $<span id="data-entry-charge">0.00</span> (Data Entry charge) -
                $<span id="payable-amount">0.00</span>
              </p>
              <p class="font-semibold text-gray-800">
    ...
    <div class="bg-white rounded-lg p-6 w-1/3 max-w-md mx-4">
      ...
      <div class="mt-4">
        ...
        <div class="grid grid-cols-2 gap-2">
          <!-- Add payment provider options here -->
        </div>
      </div>
