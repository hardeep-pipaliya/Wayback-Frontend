<script lang="ts">
  ...
  const mockTickets: Ticket[] = [
    {
      id: "d6b5d1b3-7951-4669-87b5-cd6bbb69db07",
    ...
    {
      id: "d6b5d1b3-7951-4669-87b5-cd6bbb69db08",
  ...
  //   goto(`/tickets/update/${ticketId}`);
  // }

  // function handleViewTicket(ticketId: string) {
  //   goto(`/tickets/view/${ticketId}`);
  // }
...
<div class="max-w-7xl mx-auto">
  ...
  <!-- Table Section -->
  <div
    class="rounded-xl mt-4 border border-solid border-gray-200 overflow-auto bg-white"
  >
          ...
          <tr class="transition-all duration-500 hover:bg-gray-50">
            ...
            <td class="py-3.5 px-4">
              <div class="flex font-poppins">
                ...
                class="mr-2"
                  on:click={() => goto(`/tickets/view/${ticket.id}`)}
                  title="View ticket"
                >
                  <svg
                    width="32"
