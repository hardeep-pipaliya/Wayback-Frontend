<script lang="ts">
  ...
  // Static user data (replace with API call later)
  ...
  // Load user data based on updateId
  function loadUserData() {
    isLoading = true;
    
    // Simulate API call delay
    setTimeout(() => {
      const user = staticUsers.find(u => u.id === updateId);
      ...
      if (user) {
        ...
        console.error('User not found:', updateId);
        // You could redirect to users list or show error
      }
  ...
  function handleSubmit() {
    ...
    console.log("Updating user ID:", updateId);
    
    // Dispatch event for parent component handling
    dispatch("submit", { ...formData, id: updateId });
  }
...
<div>
  <div class="flex flex-col lg:flex-row items-center justify-between gap-4 pb-6 border-b border-gray-200">
    ...
    <div>
      ...
      <p class="text-xs text-gray-500">Update user details</p>
    </div>
  ...
  {#if isLoading}
    <div class="flex justify-center items-center py-12">
      ...
      <span class="ml-2 text-gray-600">Loading user data...</span>
    </div>
  {:else if !userData}
    <div class="flex justify-center items-center py-12">
      <div class="text-center">
        ...
        <a href="/users/" class="text-indigo-600 hover:text-indigo-700">Back to Users</a>
      </div>
    </div>
  {:else}
    <!-- Form Section -->
      ...
      <div class="col-span-12 lg:col-span-4">
        <div class="p-4 border border-gray-200 rounded-lg">
          ...
          <form class="flex flex-col gap-4 pt-4" on:submit|preventDefault={handleSubmit}>
            ...
            <div class="flex flex-col md:flex-row items-start gap-3">
              <div class="block w-full">
                <label for="file-input" class="mb-2 text-sm font-medium text-gray-600 w-full flex items-center">
                  Profile Image
                </label>
