    ...
    <div class={`block ${className}`}>
      ...
      <div class="relative">
        <select
          ...
          class="!appearance-none bg-white border border-gray-300 text-gray-900 text-sm font-normal rounded-lg block w-full py-2 px-3 pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-600"
        >
